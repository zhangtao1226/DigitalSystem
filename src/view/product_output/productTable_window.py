...
class ProductTableWindow(FramelessWindow):
    def __init__(self):
        super().__init__()
    ...
    def create_navigation_breadcrumb(self, parent_layout):
        ...
        task_label = NavigationLabel("成品转换/输出表", is_clickable=False)
    ...
    def create_table(self, parent_layout):
        ...
        self.table_widget.setColumnWidth(1, 130)    # 档案类别
        self.table_widget.setColumnWidth(2, 80)     # 档案类型
        self.table_widget.setColumnWidth(3, 120)    # 批次号
        self.table_widget.setColumnWidth(4, 100)    # 起止卷/件号
        self.table_widget.setColumnWidth(5, 100)    # 本人任务起止号
        ...
        self.table_widget.setColumnWidth(9, 140)    # 处理日期
        self.table_widget.setColumnWidth(10, 160)   # 状态
        self.table_widget.setColumnWidth(11, 120)   # 操作
    ...
    def load_all_data(self):
        ...
        all_data = task_service.get_list(skip=skip, limit=page_size, task_name='成品转换/输出', operator=register)
        ...
        self.total_rows = register_service.get_total_count(task_name='成品转换/输出', operator=register)
        ...
        for row, data in enumerate(current_data):
            ...
            for col, value in enumerate(data):
                if col == len(data) - 1:
                    ...
                    confirm_button = PrimaryPushButton("查看详情")
    ...
    def on_confirm_clicked(self, row):
        ...
        if global_cache.get("current_user", None) is None:
            ...
            from src.view.product_output.productOutput_window import ProductOutputWindow
            product_output = ProductOutputWindow()
            product_output.showFullScreen()
            QTimer.singleShot(100, self.close)
