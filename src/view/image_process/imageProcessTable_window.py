...
from PySide6.QtWidgets import (QApplication, QVBoxLayout, QHBoxLayout, QHeaderView,
                               QLabel, QWidget, QSpacerItem, QSizePolicy, QTableWidgetItem,
                               QAbstractItemView)
...
class ImageProcessTableWindow(FramelessWindow):
    def __init__(self):
        super().__init__()
    ...
    def create_navigation_breadcrumb(self, parent_layout):
        ...
        task_label = NavigationLabel("图像处理任务表", is_clickable=False)
    ...
    def create_table(self, parent_layout):
        ...
        self.table_widget.setColumnWidth(10, 140)  # 状态
    ...
    def load_all_data(self):
        ...
        self.all_data = []
        all_data = task_service.get_list(skip=skip, limit=page_size, task_name="图像处理", operator=register)
        ...
        self.total_rows = task_service.get_total_count(task_name='图像处理', operator=register)
    ...
    def on_details_clicked(self, row):
        ...
        self._is_navigation = True
        from src.view.image_process.image_window import ImageWindow
